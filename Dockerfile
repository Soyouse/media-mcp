# media-mcp — image de prod (MCP HTTP génération média, multi-provider Grok/xAI).
...
#    l'IP Tailscale, voir docker-compose.yml), d'où MEDIA_MCP_CONTAINER=1 attendu à l'exécution.
FROM node:22-slim
