/**
 * Outil `media_discover` — catalogue des endpoints du provider (rechargé À CHAUD).
 *
...
export const tool = {
  name: "media_discover",
  description:
    "Liste les endpoints de génération média du provider actif, groupés par domaine. Sans argument : " +
    "résumé des catégories. Avec {category} : détail des endpoints (params + exemple).",
  inputSchema: {
    type: "object",
    properties: {
      category: {
        type: "string",
        description: "Filtre : models, image, video, audio (selon le provider)",
      },
    },
  },
  // Stryker restore all
